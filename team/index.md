...
{% include button.html link="team/join" text="Join the lab" icon="fa-regular fa-hand-wave" flip=true%} {% include button.html link="team/collaborators" text="Meet our collaborators" icon="fa-solid fa-handshake" flip=true%}
